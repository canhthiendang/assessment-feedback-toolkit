...
import { createAssessmentSlides } from './pptx-generator';
...
const slidesFields: FieldSpec[] = [
  ...
  { name: 'workedExamples', label: 'Worked examples or practice opportunities (companion document)', rows: 4 },
